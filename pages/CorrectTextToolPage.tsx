...
const CorrectTextToolPage: React.FC = () => {
  ...
  const handleCorrect = async () => {
    ...
    reader.onload = async (event) => {
        try {
            ...
            setProgress(30);
            const result = await correctText(textContent);
  ...
  return (
    <>
      <SEO
        title="AI Grammar & Spell Checker | convertai.life"
      ...
      <div className="max-w-4xl mx-auto animate-fade-in">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-display font-bold text-gray-900 dark:text-white">AI Text Corrector</h1>
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-300">Upload a text file to fix spelling and grammar mistakes.</p>
        </div>
        ...
        <div className="bg-white dark:bg-dark-card p-8 rounded-xl shadow-3d border border-gray-200 dark:border-dark-border">
          ...
          {file && (
              <div className="text-center">
                  ...
                  {status === ProcessStatus.IDLE && (
                      <button onClick={handleCorrect} className="w-full bg-gradient-to-br from-primary-light to-secondary text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl border-b-4 border-primary-dark active:border-b-0 active:translate-y-1 transform transition-all duration-150">
                          Correct Text Now
                      </button>
                  )}
              </div>
          ...
          {status === ProcessStatus.PROCESSING && (
            <div className="mt-6 text-center">
              ...
              <p className="mt-3 text-gray-600 dark:text-gray-400">AI is proofreading... please wait.</p>
            </div>
          )}
          
          {status === ProcessStatus.SUCCESS && (
            <div className="mt-8 animate-fade-in">
              <h2 className="text-2xl font-bold font-display text-gray-900 dark:text-white mb-4">Corrected Text:</h2>
...
export default CorrectTextToolPage;
