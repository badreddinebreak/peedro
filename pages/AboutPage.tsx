...
const AboutPage: React.FC = () => {
  return (
    <>
      <SEO
        title="About SmartDocs.AI | Our Mission & Technology"
        description="Learn about SmartDocs.AI's mission to provide free, secure, and AI-powered file processing tools for everyone."
      />
      <div className="max-w-4xl mx-auto animate-fade-in">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-display font-bold text-gray-900 dark:text-white">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-light to-secondary">SmartDocs.AI</span>
          </h1>
